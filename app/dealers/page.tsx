          ...
          <div className="sec-head">
            ...
            <div>
              <p className="lead" style={{ marginBottom: 12 }}>
                Найдите официального партнёра рядом: познакомьтесь с машиной вживую, получите
                консультацию по проекту, монтаж, запуск и дальнейшее обслуживание.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="section bg-gray">
          <div className="wrap">
            <div className="grid g3">
              ...
              <div>
                <p className="eyebrow">Поддержка проекта</p>
                <h3>От выбора до запуска</h3>
                <p className="small">
                  Партнёр поможет проверить инженерные условия, подобрать конфигурацию, подготовить
                  рабочую зону и организовать обучение команды.
                </p>
              </div>
              <div>
